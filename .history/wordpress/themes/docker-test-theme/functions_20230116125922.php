...
function sailthru_first_paragraph_into_content( $content = '' ) {
    if( $content !== '' ) {
        ...
        $content = preg_replace( '#<p.*?aa-poll-querstion.*?<div.*?end-aa-widget.*?>#', '', $content ); #remove widget
        $content = preg_replace( '#<div.*?start-aa-widget.*?><.*?end-aa-widget.*?>#', '', $content ); #remove widget
